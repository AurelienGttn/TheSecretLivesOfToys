...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    {
        [SerializeField] private float m_MaxEnginePower = 20f;        // The maximum output of the engine.
        ...
        [SerializeField] private float m_YawEffect = 1.0f;            // The strength of effect for yaw input.
        [SerializeField] private float m_BankedTurnEffect = 0.2f;     // The amount of turn from doing a banked turn.
